...
| Channel | Use For |
|---|---|
| [Discussions](https://github.com/emrecanozturk/intentflow-android/discussions) | Questions, ideas, adoption stories, roadmap feedback, and examples. |
| [Issues](https://github.com/emrecanozturk/intentflow-android/issues) | Reproducible bugs, concrete feature requests, documentation gaps, and AI generation feedback. |
| [Security](https://github.com/emrecanozturk/intentflow-android/security/policy) | Private vulnerability reporting. |
| [Wiki](Home) | Product guide, architecture model, AI playbook, migration guidance, and operational readiness. |
...
Keep discussions technical, respectful, and evidence-based. See the repository [Code of Conduct](https://github.com/emrecanozturk/intentflow-android/blob/main/CODE_OF_CONDUCT.md).
