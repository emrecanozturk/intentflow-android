...
Use Jetpack Compose as an adapter:
...
Use Android View adapters as adapters:
...
IntentFlow avoids retain-heavy patterns by keeping the store as a coroutine-backed store and observations cancellable.
...
- avoid storing Android Views or Jetpack Compose objects in reducers, states, events, or effects
