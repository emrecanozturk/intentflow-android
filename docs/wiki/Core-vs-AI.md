...
- Kotlin state, intent, event, effect, output, and route types
- pure reducer
- effect handler
- store
- projection
...
| Concern | Core | AI |
|---|---|---|
| Source of truth | Kotlin types and tests | Kotlin types, tests, and manifest |
| AI safety | Human review | Human review plus machine-readable contract |
| Generated files | Kotlin skeleton | Kotlin skeleton plus manifest |
