...
IntentFlow is not a rejection of existing Android architectures. It is a synthesis around a different center: workflow behavior.
...
- Google Samples, Android Architecture Samples: https://github.com/android/architecture-samples
...
- Square Workflow: https://github.com/square/workflow-kotlin
...
|---|---|---|---|
| MVC | Native to Android, easy to start. | View controllers gather networking, formatting, navigation, validation, and state. | View controllers render projections and send intents only. |
...
| VIP / Clean Kotlin | Clean request-response cycle. | Can feel scene-heavy and less natural for async, retry, offline, or long-running flows. | State machine shape makes long workflows explicit. |
