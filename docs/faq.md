...
## Does IntentFlow require Jetpack Compose?

No. Jetpack Compose and Android Views are both supported as adapters. See `examples/compose-example` and `examples/viewmodel-example`.
